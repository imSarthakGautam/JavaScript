...
const watchList = [
  ...
  function getRating(watchList) {
    ...
    .filter(film => film.Director === "Christopher Nolan") //filter Nolan's films
    .map(film => Number(film.imdbRating)) //to Number for all ratings to perform avg
    .reduce((sumOfRatings, rating) => sumOfRatings + rating) /watchList.filter(film => film.Director === "Christopher Nolan").length;
    //reduce:sum of rating/filter: no of films
